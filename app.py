        ...
        if os.path.exists(INTENTS_FILE):
            ...
            default_intents = {
                "intents": [
                    ...
                    {
                        "tag": "help",
                        "patterns": ["help", "what can you do", "how does this work", "what help can you provide"],
                        "responses": ["I can help answer questions, provide information, and assist with various tasks. Try asking me something!"]
                    }
                ]
            }
...
def load_faq():
    try:
        if os.path.exists(FAQ_FILE):
            ...
            # Create default FAQ if file doesn't exist
            default_faq = pd.DataFrame({
                ...
                'answer': [
                    'I am an AI chatbot designed to help answer your questions.',
...
if HAS_TORCH and os.path.exists(DATA_PTH):
    try:
        ...
        tags = data.get("tags", [])
        try:
            # Create a simple model if no model class is available
...
def special_commands(msg):
    ...
    if msg.startswith("/help"):
        return ("help", "🤖 Available commands:\n\n• /book [item] - Book a service\n• /recommend - Get recommendations\n• /troubleshoot - Get troubleshooting help\n• /clear - Clear chat history\n• /feedback - Provide feedback\n\nI can also help with general questions!")
...
if st.sidebar.button("📋 View Common Questions", use_container_width=True):
    if faq_df is not None and not faq_df.empty:
        ...
        for i, row in faq_df.head(5).iterrows():
